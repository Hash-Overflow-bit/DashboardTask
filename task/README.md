...
- New site from Git → pick the repository
- Base directory: `task`
- Build command: `npm run build`
...
![Mobile Chat Flow](public/screenshots/mobile-chat.png)
```
...
- Environment variables are not required for the mock APIs, but you can switch to your own backend by updating the fetch URLs in `src/pages/Dashboard.jsx`.
